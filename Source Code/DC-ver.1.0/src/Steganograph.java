...
public class Steganograph
{
	...
	private static class AboutFrame extends JFrame implements ActionListener
	{
		...
		public AboutFrame()
		{
			...
			lblName= new MyJLabel("By:   MRTV", new Font("Monotype Corsiva", Font.PLAIN, 14), GREEN, BLACK);
			lblEmail= new MyJLabel("      c3s@gmail.com", GREEN, BLACK);
			lblPhone= new MyJLabel("      +91 9999999999", GREEN, BLACK);
		...
		public void actionPerformed(ActionEvent e)
		{
			if(e.getSource()== btnVisit)
				new HTMLFrame("http://c3s.addr.com", true);
			...
			if(e.getSource()== btnComments)
				new HTMLFrame("http://c3s.addr.com/comments.html", true);
